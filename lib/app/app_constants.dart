class AppConstants {
  static const String hasher = 'vroomApp@#%!!!AFDA>F<A#';
  static const String accessTokenKey = "user-access-token";
  static const String userGarageValueKey = "user-total-garage-value";
  static const String userFullNameKey = "user-full-name-value";
  static const String userUserNameKey = "user-user-name-value";
  static const String userAvatarKey = "user-avatar-value";
  static const String userWroomsKey = "user-wrooms-value";
